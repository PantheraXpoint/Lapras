...
# `rag` package resolves when run as `python scripts/generate_three_case_captions.py`.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", type=str, default=None, help="Served model name (overrides LLM_MODEL env)")
